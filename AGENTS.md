...
This file is the quick-reference operating contract for maplit-kotlin. The longer
...
maplit-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`maplit`](https://crates.io/crates/maplit). Upstream Rust is the behavioral oracle while the
