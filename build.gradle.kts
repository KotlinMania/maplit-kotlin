...
kotlin {
    ...
    swiftExport {
        moduleName = "Maplit"
        flattenPackage = "io.github.kotlinmania.maplit"
    }

    android {
        namespace = "io.github.kotlinmania.maplit"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "maplit-kotlin", version.toString())

    pom {
        name.set("maplit-kotlin")
        description.set("Kotlin Multiplatform port of bluss/mapl - Collection “literal” macros for HashMap, HashSet, BTreeMap, and BTreeSet")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/maplit-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/maplit-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/maplit-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/maplit-kotlin.git")
        }
    }
}
...
dependencies {
    ...
    codeqlAndroidAar("io.github.kotlinmania:btree-kotlin-android:0.2.1")
}
