...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Maplit.swiftmodule/`
...
//      `import Maplit` above would fail at compile time.
//
//   2. The static archive `libMaplit.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Maplit" }` and
//      `flattenPackage = "io.github.kotlinmania.maplit"` configuration in
